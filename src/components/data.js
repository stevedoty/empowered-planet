export const MAIN_DATA = {
  ...
  MOVIELIST:{
    title:"Movies List",
    subtitle:"A list of inspirational and eye opening films",
    list:[
      ...
      {title:"Garden State", time:"time", description:"description"},
      ...
      {title:"The Intouchables", time:"time", description:"description"},
      {title:"4 Minute Mile", time:"time", description:"description"},
      ...
      {title:"Men Of Honor", time:"time", description:"description"},
      {title:"Invincible", time:"time", description:"description"},
      {title:"Miracle", time:"time", description:"description"},
      {title:"The Postman", time:"time", description:"description"},
